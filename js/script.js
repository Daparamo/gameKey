$(function()
{
	...
	var puntaje = 0;
	//var puntaje = 0;
	swal("BIENVENIDO AL JUEGO DE LAS LETRAS ", "Escoge la dificultad", "");
	...
	{			
		...
		$(".letra_" + letraPone).addClass("'animated "+animateIn[aleatorio]+"'");//+animateIn[aleatorio]
	};
